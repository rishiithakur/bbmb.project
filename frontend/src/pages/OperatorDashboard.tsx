...
const OperatorDashboard: React.FC = () => {
  ...
  const editPrefill = editingLog ? {
    ...
    // DamObservation details fields
    spillway_gates_open: editingLog.data.details?.spillway_gates_open != null ? parseInt(editingLog.data.details.spillway_gates_open) : undefined,
    spillway_opening_m: editingLog.data.details?.spillway_opening_m != null ? parseFloat(editingLog.data.details.spillway_opening_m) : undefined,
    spillway_discharge_cusecs: editingLog.data.details?.spillway_discharge_cusecs != null ? parseFloat(editingLog.data.details.spillway_discharge_cusecs) : undefined,
    sluice_gates_open: editingLog.data.details?.sluice_gates_open != null ? parseInt(editingLog.data.details.sluice_gates_open) : undefined,
    sluice_discharge_cusecs: editingLog.data.details?.sluice_discharge_cusecs != null ? parseFloat(editingLog.data.details.sluice_discharge_cusecs) : undefined,
    power_units_running: editingLog.data.details?.power_units_running != null ? parseInt(editingLog.data.details.power_units_running) : undefined,
    power_generation_mw: editingLog.data.details?.power_generation_mw != null ? parseFloat(editingLog.data.details.power_generation_mw) : undefined,
    power_discharge_cusecs: editingLog.data.details?.power_discharge_cusecs != null ? parseFloat(editingLog.data.details.power_discharge_cusecs) : undefined,
    rainfall_today_mm: editingLog.data.details?.rainfall_today_mm != null ? parseFloat(editingLog.data.details.rainfall_today_mm) : undefined,
    upstream_level_m: editingLog.data.details?.upstream_level_m != null ? parseFloat(editingLog.data.details.upstream_level_m) : undefined,
    downstream_level_m: editingLog.data.details?.downstream_level_m != null ? parseFloat(editingLog.data.details.downstream_level_m) : undefined,
    tail_water_level_m: editingLog.data.details?.tail_water_level_m != null ? parseFloat(editingLog.data.details.tail_water_level_m) : undefined,
    air_temp_celsius: editingLog.data.details?.air_temp_celsius != null ? parseFloat(editingLog.data.details.air_temp_celsius) : undefined,
    humidity_percent: editingLog.data.details?.humidity_percent != null ? parseFloat(editingLog.data.details.humidity_percent) : undefined,
    seepage_lt_per_min: editingLog.data.details?.seepage_lt_per_min != null ? parseFloat(editingLog.data.details.seepage_lt_per_min) : undefined,
    piezometer_reading: editingLog.data.details?.piezometer_reading != null ? parseFloat(editingLog.data.details.piezometer_reading) : undefined,
